...
all_stimMarkers_eventNums = find(ismember({EEG.event.type},all_stimMarkers));
            ...
            if nextStimEventNum ~= 0
                ...
                switch EEG.event(nextStimEventNum+1).type
                    ...
                    case first_RespMarkers %if there was a response
                        ...
                        %determine if a valid trial or not (single, valid rt response)
                ...
                %label this trial based on whether there was a response on next trial or not
